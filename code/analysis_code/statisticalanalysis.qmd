...
ggsave(filename = here("results","Predictions_vs_OutcomeValues.png"), plot=plot1)

#save figure of residuals 
ggsave(filename = here("results","Residuals_Plot.png"), plot=Res1)
...
#save figure of predictions vs outcome values 
ggsave(filename = here("results","Predictions_vs_OutcomeValues.png"), plot=plot2)

#save figure of residuals 
ggsave(filename = here("results","Residuals_Plot.png"), plot=Res2)
```
...
#save figure of predictions vs outcome values 
ggsave(filename = here("results","Predictions_vs_OutcomeValues.png"), plot=plot3)

#save figure of residuals 
ggsave(filename = here("results","Residuals_Plot.png"), plot=Res3)
```
