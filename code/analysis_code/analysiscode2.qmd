...
sum(processed_combined_31701_total_black$total_mblack_vax_Sept_17) 
sum(processed_combined_31701_total_black$total_mblack_vax_Oct_28) 
sum(processed_combined_31701_total_black$total_mblack_vax_Nov_24) 
sum(processed_combined_31701_total_black$total_mblack_vax_Dec_29) 
sum(processed_combined_31701_total_black$total_mblack_vax_Jan_26) 
sum(processed_combined_31701_total_black$total_mblack_vax_Feb_26)

#summing for black females by month 
sum(processed_combined_31701_total_black$total_fblack_vax_Sept_17) 
sum(processed_combined_31701_total_black$total_fblack_vax_Oct_28) 
sum(processed_combined_31701_total_black$total_fblack_vax_Nov_24) 
sum(processed_combined_31701_total_black$total_fblack_vax_Dec_29) 
sum(processed_combined_31701_total_black$total_fblack_vax_Jan_26) 
sum(processed_combined_31701_total_black$total_fblack_vax_Feb_26) 
```
...
```{r}
processed_combined_31705_total_black = processed_combined_31705 %>% select(matches("^total_(mblack|fblack)_vax"))
```

### Summing each Month variable by census tract
```{r}
#Summing for black males by month 
sum(processed_combined_31705_total_black$total_mblack_vax_Sept_17) 
sum(processed_combined_31705_total_black$total_mblack_vax_Oct_28) 
sum(processed_combined_31705_total_black$total_mblack_vax_Nov_24) 
sum(processed_combined_31705_total_black$total_mblack_vax_Dec_29) 
sum(processed_combined_31705_total_black$total_mblack_vax_Jan_26) 
sum(processed_combined_31705_total_black$total_mblack_vax_Feb_26)

#summing for black females by month 
sum(processed_combined_31705_total_black$total_fblack_vax_Sept_17) 
sum(processed_combined_31705_total_black$total_fblack_vax_Oct_28) 
sum(processed_combined_31705_total_black$total_fblack_vax_Nov_24) 
sum(processed_combined_31705_total_black$total_fblack_vax_Dec_29) 
sum(processed_combined_31705_total_black$total_fblack_vax_Jan_26) 
sum(processed_combined_31705_total_black$total_fblack_vax_Feb_26) 
```
...
```{r}
processed_combined_31707_total_black = processed_combined_31707 %>% select(matches("^total_(mblack|fblack)_vax"))
```

### Summing each Month variable by census tract
```{r}
#Summing for black males by month 
sum(processed_combined_31707_total_black$total_mblack_vax_Sept_17) 
sum(processed_combined_31707_total_black$total_mblack_vax_Oct_28) 
sum(processed_combined_31707_total_black$total_mblack_vax_Nov_24) 
sum(processed_combined_31707_total_black$total_mblack_vax_Dec_29) 
sum(processed_combined_31707_total_black$total_mblack_vax_Jan_26) 
sum(processed_combined_31707_total_black$total_mblack_vax_Feb_26)

#summing for black females by month 
sum(processed_combined_31707_total_black$total_fblack_vax_Sept_17) 
sum(processed_combined_31707_total_black$total_fblack_vax_Oct_28) 
sum(processed_combined_31707_total_black$total_fblack_vax_Nov_24) 
sum(processed_combined_31707_total_black$total_fblack_vax_Dec_29) 
sum(processed_combined_31707_total_black$total_fblack_vax_Jan_26) 
sum(processed_combined_31707_total_black$total_fblack_vax_Feb_26) 
```
