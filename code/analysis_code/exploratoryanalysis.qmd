...
```{r}
#save figure
ggsave(filename = here("results","31701_total_black_vax.png"), plot=plot_31701_total_black_vax)
```
...
```{r}
#save figure
ggsave(filename = here("results","31705_total_black_vax.png"), plot=plot_31705_total_black_vax)
```

### Turning ggplot into an interactive plot

```{r}
plotly_31705_total_black_vax = ggplotly(plot_31705_total_black_vax)
plotly_31705_total_black_vax
```
...
```{r}
#save figure
ggsave(filename = here("results","31707_total_black_vax.png"), plot=plot_31707_total_black_vax)
```
...
```{r}
#save figure
ggsave(filename = here("results","total_black_vax.png"), plot=plot_Total_black_vax)
```
...
```{r}
#save figure
ggsave(filename = here("results","31705_Gender_black_vax.png"), plot=plot_Gender_black_vax_31705)
```
...
```{r}
#save figure
ggsave(filename = here("results","31707_Gender_black_vax.png"), plot=plot_Gender_black_vax_31707)
```
...
Age_Sum_by_month_31707 = data.frame(Date = c("Sep","Oct","Nov","Dec","Jan","Feb"),
                          ...
                          Age_18_44 = c(5903, 5931, 5943, 5947, 5960, 5958), #pretty notable increase for ages 18-44 
...
```{r}
#save figure
ggsave(filename = here("results","30815_total_black_vax.png"), plot=plot_30815_total_black_vax)
```
...
```{r}
#save figure
ggsave(filename = here("results","30815_Age_black_vax.png"), plot=plot_Gender_black_vax)
```
...
### Loading the processed data in order to begin analysis for the 30907 zip code
...
Sum_by_month_30907 = data.frame(Date = c("Sep","Oct","Nov","Dec","Jan","Feb"),
                          Total = c(4956, 4917, 4888, 4851, 4866, 4894)) 
```
...
```{r}
plot_30907_total_black_vax = Sum_by_month_30907 %>% 
  ggplot(aes(Date, Total, group=1)) + 
  geom_point() + geom_line() + 
  scale_x_discrete(limits = c("Sep","Oct","Nov","Dec","Jan","Feb"))

#Adding a customization title for the plot 
plot_30907_total_black_vax = plot_30907_total_black_vax + 
  ggtitle("Vaccination Totals for Black population in the 30907 Zipcode") + 
  theme(plot.title = 
          element_text(color="red", size=10, face="bold.italic"))
plot_30907_total_black_vax
```

### Save plot
```{r}
#save figure
ggsave(filename = here("results","30907_total_black_vax.png"), plot=plot_30907_total_black_vax)
```

### Turning ggplot into an interactive plot

```{r}
plotly_30907_total_black_vax = ggplotly(plot_30907_total_black_vax)
plotly_30907_total_black_vax
```
...
#adding a title to the plot 
plot_Gender_black_vax = plot_Gender_black_vax + 
  ggtitle("Vaccination Totals for Black population by Gender in 30907") + 
  theme(plot.title = 
          element_text(color="red", size=10, face="bold.italic")) + 
  labs(y = "Vaccination Total")
plot_Gender_black_vax
...
#adding a title to the plot 
plot_Age_black_vax = plot_Age_black_vax + 
  ggtitle("Vaccination Totals for Black population by Age in 30907") + 
  theme(plot.title = 
          element_text(color="red", size=10, face="bold.italic")) + 
  labs(y = "Vaccination Total")
plot_Age_black_vax
