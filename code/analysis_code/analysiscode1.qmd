---
title: "Total Amount of Vaccinations Among African Americans in the Target Zip Codes"
format: html
editor: visual
echo: FALSE 
---
...
# Analysis of the Amount of Vaccinations Among African Americans in Each Target Zip Code
...
### Saving the combined data for African Americans for future use. Will be useful when stratifying the African American population by age and gender
...
#### Using the select() function to subset the data frame by columns that start with "total_black_vax" which are variables with a total count of African Americans with at least one dose of the COVID-19 vaccine by month
...
plot_31701_total_black_vax = plot_31701_total_black_vax + 
  ggtitle("Vaccination Totals for African Americans in the 31701 Zipcode") + 
  theme(plot.title = 
...
### Dropping all variables except for total black variables in order to obtain vaccination rates of all African Americans in the 31705 zip code 
```{r}
...
plot_31705_total_black_vax = plot_31705_total_black_vax + 
  ggtitle("Vaccination Totals for African Americans in the 31705 Zipcode") + 
  theme(plot.title = 
          element_text(color="red", size=10, face="bold.italic"))
```
...
### Dropping all variables except for total black variables in order to obtain vaccination rates of all African Americans in the 31707 zip code 
```{r}
...
plot_31707_total_black_vax = plot_31707_total_black_vax + 
  ggtitle("Vaccination Totals for African Americans in the 31707 Zipcode") + 
  theme(plot.title = 
          element_text(color="red", size=10, face="bold.italic"))
```
...
plot_Total_black_vax = plot_Total_black_vax + 
  ggtitle("Vaccination Totals for African Americans in Target Zip Codes") + 
  theme(plot.title = 
          element_text(color="red", size=10, face="bold.italic")) + 
