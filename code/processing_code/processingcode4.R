...
save_data_location = here("data", "processed_data","Dec", "processed_data_31701_Dec.rds")
saveRDS(Zip_31701_Dec, file = save_data_location)

#saving clean data to processed_data folder: 31705
save_data_location2 = here("data", "processed_data","Dec", "processed_data_31705_Dec.rds")
saveRDS(Zip_31705_Dec, file = save_data_location2)

#saving clean data to processed_data folder: 31707
save_data_location3 = here("data", "processed_data", "Dec", "processed_data_31707_Dec.rds")
