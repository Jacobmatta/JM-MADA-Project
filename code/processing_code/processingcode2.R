...
save_data_location = here("data", "processed_data","Oct", "processed_data_31701_Oct.rds")
saveRDS(Zip_31701_Oct, file = save_data_location)

#saving clean data to processed_data folder: 31705
save_data_location2 = here("data", "processed_data","Oct", "processed_data_31705_Oct.rds")
saveRDS(Zip_31705_Oct, file = save_data_location2)

#saving clean data to processed_data folder: 31707
save_data_location3 = here("data", "processed_data", "Oct", "processed_data_31707_Oct.rds")
